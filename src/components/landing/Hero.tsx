...
export function Hero() {
    return (
        <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#2d2d2d] text-white">
            {/* Background Pattern (Subtle embroidery texture feel) */}
            ...
            <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                >
                    ...
                    >
                        <Link href="/catalog">
                            <Button size="lg" className="w-full sm:w-auto text-lg h-14 px-8 rounded-full bg-[var(--color-primary)] hover:bg-[var(--color-primary)]/90 text-white shadow-lg shadoW-[var(--color-primary)]/25 transition-all hover:scale-105">
                                Explorar Colección
                            </Button>
                        </Link>
                        <Link href="/about">
                            <Button variant="outline" size="lg" className="w-full sm:w-auto text-lg h-14 px-8 rounded-full border-white/20 text-white hover:bg-white/10 hover:text-white backdrop-blur-sm transition-all hover:scale-105">
                                Nuestra Historia
                            </Button>
                        </Link>
                    </motion.div>
                ...
                >
                    ...
                    <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-black/20 backdrop-blur-sm">
                        <Image
                            src="/images/vestido-negro.jpg" // Using existing asset
                        ...
                        {/* Overlay Gradient for text legibility if needed, or style */}
